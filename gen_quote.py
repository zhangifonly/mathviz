...
# ===== 七、商业使用界定 =====
add_heading(doc, '七、商业使用界定')
add_body(doc, '本平台公开版本依据 PolyForm Noncommercial 协议授权，非商业使用免费。为避免歧义，'
              '双方对“商业使用”作如下界定——属于下列任一情形的，均须取得商业授权：',
         color=GRAY)
add_bullet(doc, '以本平台开展任何收费课程、付费培训、付费会员或其他向学员/用户收取费用的教学服务；')
add_bullet(doc, '将本平台用于民办教育机构、培训机构、企业等以营利为目的的主体的日常运营；')
add_bullet(doc, '以 SaaS、在线平台、App 等形式对外提供服务，无论是否直接对终端用户收费；')
add_bullet(doc, '将本平台或其衍生品集成进任何对外销售或商业分发的产品。')
add_body(doc, '反之，公立学校、公益机构等非商业主体，将本平台用于不收费的课堂教学、教研与学习，'
              '属非商业使用，依协议免费，无需购买本授权。',
         size=9.5, color=LIGHT)

# ===== 八、合同关键条款 =====
add_heading(doc, '八、合同关键条款')
