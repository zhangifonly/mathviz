...
export const pseudosphereScenes: NarrationLineScene[] = [
  ...
  { lineId: 'lim-1', sectionId: 'limit', scene: { id: 'lim-1', type: 'interactive', interactive: { allowParamChange: true } }, lineState: { params: { a: 0.6 }, annotation: { text: '拖动改变半径', position: 'top' } } },
  { lineId: 'lim-2', sectionId: 'limit', scene: { id: 'lim-2', type: 'interactive', interactive: { allowParamChange: true } }, lineState: { params: { a: 1.0 }, annotation: { text: '腰部那圈边缘去不掉', position: 'bottom' } } },
  { lineId: 'lim-3', sectionId: 'limit', scene: { id: 'lim-3', type: 'interactive', interactive: { allowParamChange: true } }, lineState: { params: { a: 1.5 }, annotation: { text: '希尔伯特定理', position: 'bottom' } } },
